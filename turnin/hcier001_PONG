...
enum enemypaddle_States{waittostart, start2, init2, pos1, pos2, pos3, pos4, pos5, pos6, waitenemy };
...
enum ballmovements_States{start3, init3, ballup, ballcenter, balldown, ballup2, ballcenter2, balldown2};
